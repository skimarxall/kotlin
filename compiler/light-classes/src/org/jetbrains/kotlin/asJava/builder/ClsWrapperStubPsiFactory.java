...
public class ClsWrapperStubPsiFactory extends StubPsiFactory {
    ...
    public PsiClass createClass(@NotNull PsiClassStub stub) {
        ...
        return new ClsClassImpl(stub) {
            ...
            boolean isSyntheticValuesOrValueOfMethod(PsiMethod method) {
                if (!(method instanceof SyntheticElement)) return false;
                String methodName = method.getName();
                return DescriptorUtils.ENUM_VALUE_OF.asString().equals(methodName) ||
                       DescriptorUtils.ENUM_VALUES.asString().equals(methodName);
            }
